...
# 课程章节模型
class ClassChapter(models.Model):
    name = models.CharField(verbose_name='章节名',max_length=100)
    class_model = models.ForeignKey(MiClass,verbose_name='课程', on_delete=models.CASCADE, related_name='class_name')
# 视频模型
class MiVoide(models.Model):
    file = models.FileField(upload_to="video")
    file_name = models.CharField(max_length=100)
    chapter_name = models.ForeignKey(ClassChapter, related_name='class_chapter', on_delete=models.CASCADE)
# 评论模型
class Comment(models.Model):
    lesson = models.ForeignKey(MiClass,verbose_name='评论的课程', on_delete=models.CASCADE,related_name='lessonComment',null=False)
...
class CourseMaterials(models.Model):
    ...
    data = models.ForeignKey(MiClass,related_name='materials',on_delete=models.CASCADE)